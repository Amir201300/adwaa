...
class BlogController extends Controller
{
    ...
    {
        $cats=BlogCat::get();
        return view('Admin.Blog.index',compact('cats'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return $this->apiResponseMessage(1,'تم اضافة الخبر بنجاح',200);
    }
    ...
    public function update(Request $request)
    {
        ...
        return $this->apiResponseMessage(1,'تم تعديل الخبر بنجاح',200);
    }
